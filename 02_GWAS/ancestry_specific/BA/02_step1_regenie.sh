...
#SBATCH --chdir=/sc-projects/sc-proj-computational-medicine/people/Martijn/02_UKBB_NMR/03_GWAS_NMR/04_gwas_ancestry_specific/02_gwas_pop_afr
#SBATCH -J RegStep1_popAFR
...
grep -f input/afr_samples_n6744_regenie.txt /sc-resources/ukb/data/bulk/genetic/array/step1_regenie_44448/pruned_genotypes/ukb22418_allChrs.pruned.fam > input/subset.fam
...
samples=input/afr_samples_n6744_regenie.txt                                                                             # Samples to keep
